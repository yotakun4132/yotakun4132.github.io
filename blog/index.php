        ...
        <div class="contents">
		  ...
		  <h2>記事一覧</h2>
			<ul class="article">
				...
				-->
                <li class="article_li">
					<a class="article_link" href="content/240529/index.php">
						<div class="article_img">
							<img alt="" src="content/240529/image/0.png">
						</div>
						<div class="article_text">
							<div class="article_title">SBI証券のジュニアNISA口座を解約して現金化するまでの話</div>
							<time class="article_date">2024年5月29日</time>
						</div>
					</a>
				</li>
                <li class="article_li">
					<a class="article_link" href="content/240410/index.php">
						<div class="article_img">
							<img alt="" src="content/240410/image/vsftpdSQUARE.png">
						</div>
						<div class="article_text">
							<div class="article_title">Ubuntu 22.04でvsftpdを使ってFTPをセットアップ</div>
							<time class="article_date">2024年4月10日</time>
						</div>
					</a>
				</li>
                <li class="article_li">
					<a class="article_link" href="content/240327/index.php">
						<div class="article_img">
							<img alt="" src="content/240327/image/01.png">
						</div>
						<div class="article_text">
							<div class="article_title">【寿司打チート】寿司打で超高速チートをやる方法！！！誰でも簡単に試せる！？</div>
							<time class="article_date">2024年3月27日</time>
						</div>
					</a>
				</li>
				<li class="article_li">
